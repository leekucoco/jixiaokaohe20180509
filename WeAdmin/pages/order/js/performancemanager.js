layui.use('table', function(){
    ...
    table.render({
        ...
        ,cols: [[
            ...
            ,{field:'info',width:120,sort: true,title:"备注信息"}
            ,{field:'splitmethod', width:120,title:"分配方案ID"}
            //  ,{field:'state',width:120, title:"记录状态"
            //     ,templet: function (d) {
    ...
    //监听工具条
    table.on('tool(performancemanagedemo)', function(obj){
        var data = obj.data;
        console.log(data)
        var msg = ""
